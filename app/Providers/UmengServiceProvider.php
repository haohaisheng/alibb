...
class UmengServiceProvider {
	...
	function sendAndroidUnicast($MYID,$ticker,$title,$text,$extra) {
		try {
			...
			//$unicast->setPredefinedKeyValue("device_tokens",    null); 
			$unicast->setPredefinedKeyValue("alias_type",    "MYID"); 
			$unicast->setPredefinedKeyValue("alias",    $MYID); 
	...
	function sendIOSUnicast($MYID,$ticker,$title,$text,$extra) {
		try {
...
//$demo = new Demo("54dd9627fd98c51a4e000815", "aybocxm3m8coetwsyi5wdjpfxcw3ip9m");
//$demo->sendAndroidUnicast();
//$demo = new Demo("54dc50b5fd98c55d7200062a", "8uglfunz1dryldrnngjem38flpdjl2lv");
//$demo->sendIOSUnicast();
