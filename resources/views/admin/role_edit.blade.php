                ...
                <form class="form-horizontal">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="hidden" id="rid" value="{{$role->role_id}}">
                                <input type="text" class="form-control input-inline input-medium" id="rname"
                                       placeholder="角色名称" value="{{$role->role_name}}">
    ...
    var vm = new Vue({
        ...
        methods: {
            sub: function (event) {
                ...
                this.$http.post('/editrole', senddata, function (data) {
