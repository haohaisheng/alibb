<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu " data-keep-expanded="false" id="memuch"
    data-auto-scroll="true" data-slide-speed="200">
    <li class="start active open">
        <a href="#1" onclick="menu_action('/{{$initaction}}')">
            <i class="icon-home"></i>
            <span class="title">系统全览</span>
        </a>
    </li>
    @foreach ($topmenu as $tm)
        @if ($tm->fid==0)
            <li class="">
                <a href="javascript:;">
                    <i class="{{$tm->icon}}"></i>
                    <span class="title">{{$tm->menu_name}}</span>
                ...
                <ul class="sub-menu">
                    @foreach ($menus as $m)
                        @if ($tm->menu_id==$m->fid)
                            <li>
                                <a onclick="menu_action('{{$m->menu_url}}')">
                                    {{$m->menu_name}}</a>
                            </li>
                        @endif
                    @endforeach
...
<!-- <li class="">
        ...
        <ul class="sub-menu">
            <li>
                <a onclick="menu_action('/user')">
                    用户管理</a>
            </li>
            <li>
                <a onclick="menu_action('/menu')">
                    菜单管理</a>
            </li>
            <li>
                <a onclick="menu_action('/role')">
                    角色管理</a>
            </li>
            <li>
                <a onclick="menu_action('/rolemenu')">
                    角色权限</a>
            </li>
        </ul>
    </li>-->
