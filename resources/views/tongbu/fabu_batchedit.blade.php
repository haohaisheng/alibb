            ...
            <div class="portlet-body form">
                <form role="form">
                    <div class="form-body" style="margin-left:10px; ">
                        ...
                        <div class="form-group">
                            <div class="radio-list">
                                ...
                                <button type="button" class="btn grey-cascade" v-on:click="randimage">打乱图片顺序</button>
                            </div>
                        </div>
                      <!--  <div class="form-group">
                            <div class="radio-list">
                                ...
                                <button type="button" class="btn grey-cascade" v-on:click="generate">产品型号相同的图片</button>
                            </div>
                        </div> -->
                        <div class="form-group">
                            <div class="radio-list">
                                ...
                                <button type="button" class="btn grey-cascade" v-on:click="deleteimg('none')">删除选中图片
                                </button>
                    ...
                    <div class="form-actions" style="text-align: right">
                        ...
                        <button type="button" v-on:click="fabu()" class="btn blue">发布</button>
