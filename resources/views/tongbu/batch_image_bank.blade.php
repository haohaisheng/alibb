    ...
    var vm9_1 = new Vue({
        ...
        methods: {
            ...
            submit: function (id) {
                ...
                var ids = window.parent.document.getElementById("ids").value;
                var imgurl = window.parent.document.getElementById("imgurl").value;
                senddata = {
                    ids: ids,
                    imags: this.chks,
                    checkimg: imgurl
                };
                this.$http.get('/replacedetailimg', senddata, function (data) {
                    if (eval(data).code) {
                        parent.vm8.list(ids);
                        parent.vm8.imglist();
